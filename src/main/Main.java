...
public class Main implements LogListener {
	...
	private int showHelp(int status, String cmd, String errorMessage) {
		...
		System.out.println("\t(-t|--template) template/: set the template input directory");
		System.out.println("\t(-o|--output) output_dir: set the output directory");
		System.out.println("\t(-d|--database) word1|word2: set the uppercase database name");
		System.out.println("\t(-w|--write) project.properties: save configuration to file when finishes");
